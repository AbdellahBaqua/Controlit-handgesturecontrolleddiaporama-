...
def detect_hand_gesture(hand_landmarks):
    # Simple gesture: only index finger up
...
while True:
        ...
        if face_locations:
            ...
            for i, face_encoding in enumerate(face_encodings):
                ...
                if match[0]:
                    ...
                    cv2.putText(frame, f"Professor ({confidence:.0%})", (left, top - 10),
                    ...
                    cv2.putText(frame, f"Unknown ({confidence:.0%})", (left, top - 10),
    ...
    if professor_visible:
        ...
        if pose_results.pose_landmarks:
            ...
            for wrist_index in wrist_indices:
                ...
                y2 = min(y + box_size // 2, frame_height)
                    ...
                    if hand_results.multi_hand_landmarks:
                        for hand_landmarks in hand_results.multi_hand_landmarks:
                            ...
                            for lm in hand_landmarks.landmark:
                                ...
                                cv2.circle(hand_region, (lm_x, lm_y), 3, (0, 255, 255), -1)
                            ...
                            if gesture:
                                cv2.putText(frame, f"Gesture: {gesture}", (x1, y1 - 40),
    ...
    if debug_mode:
        ...
        cv2.putText(frame, f"Model: {model_name}", (10, frame.shape[0] - 30),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
        cv2.putText(frame, f"Last detection: {time.time() - last_detection_time:.1f}s ago",
                    (10, frame.shape[0] - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)

    cv2.imshow("Professor Gesture Control", frame)
